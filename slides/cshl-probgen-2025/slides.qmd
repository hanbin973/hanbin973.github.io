...
genetic materials in the presence of recombination and drift backwards in time

![[@Wong2024]](imgs/full_arg.jpg)
...
![[tskit docs](https://tskit.dev/tutorials/what_is.html)](imgs/local_trees.svg){fig-align="center" height=300}
...
$$
\mathrm{Trait} \mid mathrm{Local trees} \quad \sim \quad ?
$$
:::
