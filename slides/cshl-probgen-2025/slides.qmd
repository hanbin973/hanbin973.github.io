...
![From [@Wong2024]](imgs/full_arg.svg){height=600}
...
::: {.fragment fragment-index=4}
Fitting REML $\mathcal{O}(n^3) \; \Rightarrow \; \mathcal{O}(n)$
:::
...
Heritability is 
$$
\small h_g^2 = \frac{\mathrm{Var}(\mathbf{g}_n)}{\mathrm{Var}(\mathbf{y}_n)}
...
::: {.r-stack}
::: {.fragment .fade-in-then-out fragment-index=2}
![](imgs/covariance-short-0.svg){fig-align="center" height=600}
:::
::: {.fragment fragment-index=3}
![](imgs/covariance-short-1.svg){fig-align="center"height=600}
:::
:::
...
::: {.fragment .fade-in-then-out  fragment-index=2}
![](imgs/covariance-long-0.svg){fig-align="center" height=600}
:::
::: {.fragment fragment-index=3}
![](imgs/covariance-long-1.svg){fig-align="center" height=600}
:::
