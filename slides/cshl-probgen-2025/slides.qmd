...
$\mathbf{y}_1 = \mathbf{u}_{13} + \mathbf{u}_{34}$ and $\mathbf{y}_2 = \mathbf{u}_{23} + \mathbf{u}_{34}$
::: 
...
![](imgs/covariance-short-0.svg){.fragment fig-align="center" .fade-in-then-out fragment-index=1 height=500}
![](imgs/covariance-short-1.svg){.fragment fig-align="center" fragment-index=2 height=500}
...
![](imgs/covariance-long-0.svg){.fragment fig-align="center" .fade-in-then-out fragment-index=1 height=500}
![](imgs/covariance-long-1.svg){.fragment fig-align="center" fragment-index=2 height=500}
