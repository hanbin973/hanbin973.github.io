...
- The covariance between the indicators are higher-order terms of mutation rates, so we ignore [@Wakeley2008]
$$
	\begin{aligned}
...
- One might be tempted to invoke the central limit theorem to $\mathbf{u}_e$ (sum of indicators)
	$$
		...
		\xrightarrow_{s_e \rightarrow \infty} N(0,1^2)
	$$
- The convergence is unlikely to be fast enough given the small value of $\mathbf{E}[\mathbf{1}_{ep}]$.
:::
