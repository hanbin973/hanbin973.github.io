...
![A local tree spanning over the genome](imgs/tree-branch.svg){.absolute top=200 left=0 height=600}
:::
...
::: {.fragment fragment-index=4}
Fitting REML $\mathcal{O}(n^3) \; \Rightarrow \; \mathcal{O}(n\log n ^2)$
:::
...
::: {.fragment}
All-in-one genome-wide association studies and fine-mapping
:::
