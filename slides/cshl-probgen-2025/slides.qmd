...
::: {.fragment}
This the ancestral recombination graph linear mixed model (ARG-LMM)
:::
...
$$
	\mathrm{Var}(h_{n1}+h_{n2}) = \mathrm{Var}(h_{n1}) + \mathrm{Var}(h_{n2}) + \textcolor{red}{\mathrm{Cov}(h_{n1},h_{n2})}
$$
...
Collaborators: Nate Pope (Oregon), Jerome Kelleher (Oxford), Gregor Gorjanc (Edinburgh), and Peter Ralph (Oregon)
