...
:::: {.columns}
::: {.column width="45%"}
![](imgs/tree-0.svg){height="100%"}
:::

::: {.column width="45%"}
$$
\begin{aligned}
\mathbf{y}_1 &= \boldsymbol{\beta}_1 +\boldsymbol{\beta}_1 \\
\mathbf{y}_2 &= \boldsymbol{\beta}_2 \\
\mathbf{y}_3 &= \boldsymbol{\beta}_2 \\
\mathbf{y}_4 &= \boldsymbol{\beta}_4 \\
\mathbf{y}_5 &= \boldsymbol{\beta}_2 
\end{aligned}
$$
:::
::::
