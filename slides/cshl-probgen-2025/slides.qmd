...
::: {.fragment}
We call this generative process as the ancestral recombination graph linear mixed model (ARG-LMM)
:::

::: {.incremental}
- The random effects are tied to a physical process - Mutations!
- Their properties can be deduced from the mutational process
- We did not *assume* but *derived* the model
:::
...
![](imgs/runtime.svg){.fragment fig-align="center" width=80%}
...
![](imgs/estimation_true.svg){height="600"}
:::

:::{.fragment .fade-in-then-out}
**Inferred (tsinfer+tsdate) trees**

![](imgs/estimation_infer.svg){height="600"}
:::
...
![](imgs/prediction.svg){.fragment fig-align="center" width=70%}
