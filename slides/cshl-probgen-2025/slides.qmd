...
::: {.r-stack}
![](imgs/estimation_true.svg){.fragment width="200%"}

![](imgs/estimation_infer.svg){.fragment width="200%"}
:::
...
True trees are better, but inferred trees are not lagging too much!
