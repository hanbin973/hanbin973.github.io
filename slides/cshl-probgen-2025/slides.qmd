...
Next, mutations should occur on those branches
The effect of a branch is the sum over the effect of mutations on it
:::

::: {.fragment fragment-index=8}
$\text{Effect of edge 4-5} = 0$
:::

::: {.fragment fragment-index=10}
$\text{Effect of edge 4-5} = \boldsymbol{\beta}_4$
:::
