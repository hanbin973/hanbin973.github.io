...
![](imgs/estimation_true.svg){height=200%}
:::

:::{.fragment .fade-in-then-out style="text-align: center"}
**Inferred ($\mathsf{tsinfer+tsdate}$) trees**

![](imgs/estimation_infer.svg){height=200%}
:::
...
![](imgs/estimation_true.svg){width="30%"}
:::

:::{.fragment .fade-in style="text-align: center"}
**Image 2 title**

![](imgs/estimation_infer.svg){width="50%"}
:::
