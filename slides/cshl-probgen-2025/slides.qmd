...
\begin{aligned}
	...
	\left[ \sum_{p: p \in e} \boldsymbol{\beta}\mathbf{1}_{ep} \right] \\
...
$$
\textcolor{red}{Conjecture:} \text{Selection \quad \Rightarrow \quad Fixed effects?}
$$
:::
...
::: {.incremental}
- $\textsf{tslmm}$ utilizes an efficient genetic relatedness matrix - vector product to fit the REML objective
- Assumes
$$
	\frac{1}{s_e} \sum_{p: p \in e} \boldsymbol{\beta}^2 u_{ep} = \tau_e^2 = \tau^2
$$
for all edges $e \in \mathbf{E}$.
- Approximation likely to be better
