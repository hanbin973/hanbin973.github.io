...
![](imgs/tree-branch.svg){.absolute top=50 left=50 height=600}
:::


::: {.fragment .fade-in-then-out fragment-index=2}
![](imgs/tree-0.svg){.absolute top=50 left=50 height=600}
$$
...
![](imgs/tree-1.svg){.absolute top=50 left=50 height=600}
$$
