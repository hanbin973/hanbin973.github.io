...
::: {.fragment fragment-index=1}
![](imgs/covariance-0.svg){height=500 fig-align="center"}
:::

::: {.fragment fragment-index=3}
![](imgs/covariance-1.svg){height=500 fig-align="center"}
:::
...
\mathrm{Cov}(\mathbf{u}_{13} + \mathbf{u}_{34}, \mathbf{y}_2 = \mathbf{u}_{23} + \mathbf{u}_{34}) =
