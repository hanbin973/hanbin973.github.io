...
![Placeholder: full_arg-0](imgs/full_arg-0.svg){height=600}
...
![Placeholder: full_arg-1](imgs/full_arg-1.svg){height=600}
...
![Placeholder: local_trees](imgs/local_trees.svg){fig-align="center" height=500}
...
![Placeholder: tree-branch](imgs/tree-branch.svg){.absolute top=200 left=0 height=600}
:::


::: {.fragment .fade-in-then-out fragment-index=2}
![Placeholder: tree-0](imgs/tree-0.svg){.absolute top=200 left=0 height=600}
$$
...
![Placeholder: tree-1](imgs/tree-1.svg){.absolute top=200 left=0 height=600}
$$
...
::: {.fragment fragment-index=2}
![Placeholder: tree-branch](imgs/tree-branch.svg){fig-align="center" height=600}
:::

::: {.fragment fragment-index=7}
![Placeholder: tree-0](imgs/tree-0.svg){fig-align="center" height=600}
:::

::: {.fragment fragment-index=8}
![Placeholder: tree-1](imgs/tree-1.svg){fig-align="center" height=600}
:::
...
$$
![Placeholder: edge_weight-0](imgs/edge_weight-0.svg){height=500 fig-align="center"}
:::
::: {.fragment}
$$
\small l_e:\text{ length in time} \quad s_e:\text{ span in base pairs}
$$
![Placeholder: edge_weight-1](imgs/edge_weight-1.svg){height=500 fig-align="center"}
:::
:::
...
::: {.fragment fragment-index=1}
![Placeholder: covariance-0](imgs/covariance-0.svg){height=600 fig-align="center"}
:::

::: {.fragment fragment-index=4}
![Placeholder: covariance-1](imgs/covariance-1.svg){height=600 fig-align="center"}
:::
...
::: {.r-stack}
::: {.fragment .fade-in-then-out fragment-index=2}
![Placeholder: covariance-short-0](imgs/covariance-short-0.svg){fig-align="center" height=550}
:::
::: {.fragment fragment-index=3}
![Placeholder: covariance-short-1](imgs/covariance-short-1.svg){fig-align="center"height=550}
:::
:::
...
::: {.fragment .fade-in-then-out  fragment-index=2}
![Placeholder: covariance-long-0](imgs/covariance-long-0.svg){fig-align="center" height=550}
:::
::: {.fragment fragment-index=3}
![Placeholder: covariance-long-1](imgs/covariance-long-1.svg){fig-align="center" height=550}
:::
...
![Placeholder: geneticvariance](imgs/geneticvariance.svg){.fragment fig-align="center" height=550}

::: {.fragment .fade-out}
![Placeholder: covariance-1](imgs/covariance-1.svg){.absolute top=70 right=50 height=550}
:::
...
::: {.fragment .fade-in-then-out fragment-index=1}
![Placeholder: two-trees-empty](imgs/two-trees-empty.svg){fig-align="center" height=550}
:::

::: {.fragment .fade-in-then-out fragment-index=2}
![Placeholder: two-trees-naive](imgs/two-trees-naive.svg){fig-align="center" height=550}
:::

::: {.fragment fragment-index=3}
![Placeholder: two-trees-efficient](imgs/two-trees-efficient.svg){fig-align="center" height=550}
:::
...
## Efficiency of Matrix-Vector Multiplication

::: {.fragment}
How does $\textsf{tslmm}$ compare to other ARG-based methods?
:::

::: {.columns}

::: {.column width="50%"}
![Placeholder: matvec_compare](imgs/matvec_compare.pdf){fig-align="center" height=500}
:::

::: {.column width="50%"}
::: {.incremental}
- $\textsf{tslmm}$ uses an exact algorithm for GRM-vector products.
- `arg-needle-lib` uses a Monte-Carlo approach.
- $\textsf{tslmm}$ is **10--100x faster** than `arg-needle-lib` across varying mutation rates.
- No trade-off between accuracy and computational resources.
:::
...
![Placeholder: runtime](imgs/runtime.svg){.fragment fig-align="center" height=500}

::: {.fragment}
The runtime scales linearly with respect to the number of individuals (genome length = $10^8$)
:::

## Comparison with BOLT-LMM

::: {.fragment}
Scalability beyond conventional genotype-based methods.
:::

:::: {.columns}

::: {.column width="50%"}
![Placeholder: runtime_boltlmm](imgs/runtime_boltlmm.pdf){fig-align="center" height=500}
:::

::: {.column width="50%"}
::: {.incremental}
- `BOLT-LMM` runtime scales as $\mathcal{O}(N^{1.5}M)$.
- $\textsf{tslmm}$ scales as $\mathcal{O}(N + E \log N)$.
- $\textsf{tslmm}$ becomes faster for $N > 20,000$.
- The gap widens significantly as sample size increases.
:::
:::
...
![Placeholder: prediction](imgs/prediction.svg){.fragment fig-align="center" height="600"}
...
## Performance in Spatially Structured Populations

::: {.fragment}
Validation in realistic, non-panmictic settings.
:::

:::: {.columns}

::: {.column width="50%"}
![Placeholder: pedigree](imgs/pedigree.pdf){fig-align="center" height=600}
:::

::: {.column width="50%"}
::: {.incremental}
- Simulated spatially-restricted mating and dispersal.
- Significant isolation by distance (IBD).
- $\textsf{tslmm}$ (even with inferred ARGs) performs as well as using the true ARG or pedigree.
- Outperforms standard SNP-based GRM.
:::
:::
...
<p align="center">
![Placeholder: qr_code](imgs/qr_code.svg){height=400}
</p>
...
![Placeholder: pseudoreplication](imgs/pseudoreplication.svg){.fragment fig-align="center" height="400"}
...
![Placeholder: apples and oranges](https://whalebonemag.com/wp-content/uploads/2022/11/applesandoranges-lilguys-02.jpg){.fragment height=400 fig-align="center"}
...
![Placeholder: estimation_true](imgs/estimation_true.svg){height="700"}
:::

:::{.fragment}
**Inferred (tsinfer+tsdate) trees**

![Placeholder: estimation_infer](imgs/estimation_infer.svg){height="700"}
:::
