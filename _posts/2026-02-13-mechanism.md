...
그건 바로 간단한 회귀분석에도 현상의 원리에 대한 논의가 녹아있다는 점입니다.덕분에 원리를 바탕으로 시험가설을 결정할 수 있다는 것입니다.
...
이는 통계학적 유의성이 전가의 보도처럼 휘두르는 다른 응용통계학 분야와 극명하게 다른 부분입니다.
즉, 현상과 메커니즘에 대한 이해가 없기 때문에 통계적 유의성이라는 외부적인 기준에 의존할 수 밖에 없는 것이죠.
...
다들 통계학자는 뭔가 답을 알고 있을 거라고, 좀 더 적나라하게는 같은 데이터로 통계학적으로 유의한 결과를 낼 방법을 알 거라고 기대하는 것이죠.
