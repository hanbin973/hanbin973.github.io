...
# Standard error estimation in Generalized Linear Models (GLMs)
...
$f$가 $\theta$에 대한 함수이기 때문에 1계 도함수인 $g$는 $1 times p$ 행렬이고 $h$는 $p \times p$ 행렬입니다.
그리고 구체적인 형태를 쓰면

$$ g(y;\theta) = \left[ \frac{\partial \log{f}}{\partial \theta_j} \right]_{j} \quad j=1 \ldots p$$

$$ h(y;\theta) = \left[ \frac{\partial}^2 \log{f}}{\partial \theta_i \theta_j} \right ]_{ij} \quad i=1\ldots p, \, j=1\ldots p$$
