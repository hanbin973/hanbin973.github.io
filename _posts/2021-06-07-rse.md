...
$W= \mathbb{E}\left[XX^T\right]^{-1}$을 택하고 GMM의 objective function에 대입하면 objective function이 OLS 그 자체가 됨을 알 수 있습니다.

$$ G = \nabla_{\theta} g(Y,\theta) = - \mathbb{E}\left[XX^T\right] $$
