...
$$ \hat{\boldsymbol{\beta}} = \mathbf{argmin}_{\boldsymbol{\beta} \in \mathbb{R}^p} \left(\mathbf{y}-\mathbf{X} \boldsymbol{\beta} \right)^T \left(\mathbf{y}-\mathbf{X} \boldsymbol{\beta} \right) $$
